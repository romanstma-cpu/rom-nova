...
export const metadata: Metadata = { title: "Signal", description: "One signal in full: the case for it, the case against it, what it can absorb, and what would prove it wrong." };
