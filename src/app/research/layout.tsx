...
export const metadata: Metadata = { title: "Research", description: "Ask a question about the simulated universe and get the evidence behind the answer. Simulated, and labelled so." };
