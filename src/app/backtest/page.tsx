  ...
  return (
    <div className="p-3 flex flex-col gap-3">
      <div className="flex items-center gap-3 flex-wrap">
        ...
        {/* The sentence beside this said "the market itself is generated by
            this program" and has since it was written — at 10.5px, in faint
            grey, after two clauses about integrity checks. A returns table is
            read long before that sentence is. */}
        <span className="chip" title="The price history replayed here is the deterministic demo universe. A return measured against it demonstrates the method, not real-market performance.">
          SIMULATED
        </span>
